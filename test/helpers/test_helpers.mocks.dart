...
// in mapPolygon/test/helpers/test_helpers.dart.
...
import 'package:mapPolygon/models/boundary.dart' as _i8;
import 'package:mapPolygon/services/boundary_service.dart' as _i7;
...
/// A class which mocks [BoundaryService].
///
/// See the documentation for Mockito's code generation for more information.
class MockBoundaryService extends _i1.Mock implements _i7.BoundaryService {
  @override
  List<_i8.Boundary> get boundaries => (super.noSuchMethod(
        Invocation.getter(#boundaries),
        returnValue: <_i8.Boundary>[],
        returnValueForMissingStub: <_i8.Boundary>[],
      ) as List<_i8.Boundary>);
  ...
  @override
  _i5.Future<List<_i8.Boundary>> getBoundaries() => (super.noSuchMethod(
        Invocation.method(
          #getBoundaries,
          [],
        ),
        returnValue: _i5.Future<List<_i8.Boundary>>.value(<_i8.Boundary>[]),
        returnValueForMissingStub:
            _i5.Future<List<_i8.Boundary>>.value(<_i8.Boundary>[]),
      ) as _i5.Future<List<_i8.Boundary>>);
}
